...
//    let member: Member
    ...
    static let members = [
        QuizModel(name: "박준영", profileImageName: "pjy02", quizQuestions: [
        ...
        QuizModel(name: "정유진", profileImageName: "jyj02", quizQuestions: [
        ...
        QuizModel(name: "이시안", profileImageName: "lsa02", quizQuestions: [
        ...
        QuizModel(name: "박현렬", profileImageName: "phy02", quizQuestions: [
        ...
        QuizModel(name: "장진영", profileImageName: "jjy02", quizQuestions: [
